...
#define iPROC_EST_PND           4       /* Quedan registros por procesar */
...
typedef struct REG_FA_TRAZAPROC
{
	...
	long 	lNumAbonado;
	int		iNumRegistros;
	int		iflgRetoRep;		/* MAS-05062 Flag para marcar retoma o reproceso; 0:Proc_Normal; 1:Ret_o_Rep */
}rg_trazaproc;
...
access  int 	iCuentaFacturasPorImprimir(int , int *)	;
/*-------------------------------------------------------------------------*/
