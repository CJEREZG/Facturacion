...
PROCFLAGS=ireclen=255 oreclen=255 include=$(FA_INC_PATH) include=$(H)
INCLUDE=$(I_SYM)$(FA_INC_PATH) $(I_SYM)$(ORACLE_HOME)/precomp/public  $(I_SYM)$(H)
...
$(EXE)check_supertel: $(O)check_supertel.o $(OEXT)geora.o
	$(CC) $(CFLAGS) -o $(EXE)check_supertel $(O)check_supertel.o $(OEXT)geora.o $(PROLDLIBS)

$(EXE)check_empresas: $(O)check_empresas.o $(OEXT)geora.o
	$(CC) $(CFLAGS) -o $(EXE)check_empresas $(O)check_empresas.o $(OEXT)geora.o $(PROLDLIBS)
