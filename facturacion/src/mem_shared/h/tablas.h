...
typedef struct tagCargos_HOST
{
    ...
    char   szCodTecnologia	[TAM_HOST] [8];
}CARGOS_HOST;
...
typedef struct tagCONCEPTO_HOST
{
    ...
    short  sIndTecnologia 	[TAM_HOST];
    char   szDefTecnologia 	[TAM_HOST][8];
...
typedef struct tagProvincias_HOST
{
    ...
    char  szCodRegion    [TAM_HOST][4];
    char  szCodProvincia [TAM_HOST][6];
    char  szDesProvincia [TAM_HOST][31];
}PROVINCIAS_HOST;
...
typedef struct tagTipImpues_HOST
{
    ...
    char   szDesTipImpue  [TAM_HOST][41];
...
typedef struct tag_FAC_CICLO_HOST
{
    char   szRowid       [TAM_HOST][19];
    long   lCodCliente   [TAM_HOST]    ;
    short  iCodProducto  [TAM_HOST]    ;
...
typedef struct tag_FAC_CICLO_HOST_NULL
{
...
typedef struct tag_DetCarg_Puntuales_host
{
    long   lCodCliente       [TAM_HOST]  ;
    long   lNumAbonado       [TAM_HOST]  ;
    int    iCodTipDescu      [TAM_HOST]  ;
    long   lCodConcCargo     [TAM_HOST]  ; 
    long   lCodConcDesc      [TAM_HOST]  ;
    double dMtoDcto          [TAM_HOST]  ;
    double dMtoAplicado      [TAM_HOST]  ;
    char   szRowid           [TAM_HOST][19];
}DETCARG_PUNTUALES_HOST;
...
BOOL    bfnObtGeConceptos(long *lGeConceptos,CONCEPTO **pstlGeConceptos, void* ctx);
...
BOOL	bfnObtFacClientes(long *lFacClientes, FAC_CLIENTES **pstFacClientes,void* ctx, int ciclo, long clieini, long cliefin);
BOOL	bfnObtFacCiclo(long *lFacCiclo, FAC_CICLO **pstFacCiclo,void* ctx, int ciclo, long clieini, long cliefin);
...
int ifnOraDeclararGeConceptos (void* ctx);
...
int ifnOraDeclararGeCargosBasico (void* ctx);
int ifnOraDeclararGeOptimo (void* ctx);
int ifnOraDeclararGeFeriados (void* ctx);
int ifnOraDeclararGePlanTarif (void* ctx);
int ifnOraDeclararGePenalizaciones (void* ctx);
int ifnOraDeclararFacClientes(void *ctx, int ciclo, long clieini, long cliefin);
...
int ifnOraDeclararGeDirecciones2 (void* ctx,int iTipDireccion,long ciclo, long clieini, long cliefin);
...
int ifnOraDeclararDescCargPunt (void* ctx, long ciclo);

int ifnOraContarPlaza (int *iNumPlaza,void* ctx);

int ifnOraDeclararGeOficina2 (void* ctx);
int  ifnOraLeerGeOficina2(OFICINA_HOST *pstHost,long *plNumFilas,void* ctx);
int ifnOraCerrarGeOficina2 (void* ctx);
...
int  ifnOraLeerGeCargosBasico(CARGOSBASICO_HOST *pstHost,CARGOSBASICO_HOST_NULL *pstHostNull,long *plNumFilas, void* ctx);
...
int  ifnOraLeerFacCiclo(FAC_CICLO_HOST *pstHost,FAC_CICLO_HOST_NULL *pstHostNull,long *plNumFilas,void * ctx,long ci, long cf);
...
int  ifnOraLeerDescCargPunt(DETCARG_PUNTUALES_HOST *pstHost,long *plNumFilas,void* ctx);
/********************************************************
	FIN NUEVAS ESTRUCTURAS HOMOLOGADO
********************************************************/
...
int ifnOraCerrarGeDirecciones2 (void * ctx, long ci, long cf);
...
int ifnOraCerrarDescPuntuales (void* ctx);

int ifnOraCuentaConcep (void* ctx, long *lCantConc);
/********************************************************
	FIN NUEVAS ESTRUCTURAS HOMOLOGADO
********************************************************/
...
/*static void vPrintDesc (DETCARG_PUNTUALES*,long) ;*/
