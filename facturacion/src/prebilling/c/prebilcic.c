...
{12,4130,1,0,0,
5,0,0,1,130,0,5,346,0,0,3,3,0,1,0,1,3,0,0,1,97,0,0,1,97,0,0,
32,0,0,2,99,0,5,372,0,0,3,3,0,1,0,1,3,0,0,1,97,0,0,1,97,0,0,
};
...
BOOL bPreBillingClienteCiclo (long lNumProceso,int iTipoFact)
{
  ...
  {      /* Calculo de Descuentos */
      ...
      if (bRes && !bfnDescPuntuales (stCliente.lCodCliente))
      {
          vDTrazasLog (szExeName,"\t\tProcesando Descuentos Puntuales \n",LOG01);
          bRes = FALSE                                                      ;
      }      
