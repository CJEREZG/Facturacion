...
*************************************************************************/
				...
				if(MemSharedL==TRUE)
				{
					...
					int iSemId;
					vDTrazasLog (szExeName,"\n\t\tIntenta crear semaforo para Instancias de Facturación",LOG00);
					if (!(iSemId=bfnCreaSemaforo()))
                    {
						vDTrazasLog (szExeName,"\n\t\t=> Imposible crear semaforo",LOG00);
						return FALSE;
					}
					vDTrazasLog (szExeName,"\n\t\t=>Semáforo Creado Exitosamente:[%d]",LOG00, iSemId);
                                ...
                                VENTAS       *pstVenta)
{
	...
	/*2005-12-27 faar/ ESTABILIZACIÓN DE LA FACTURACIÓN TMC... */
...
static BOOL bfnInicioCiclo_MC (char *szFecCategoria, int iTipoFact, ABONOCLI stAbo)
{
    ...
    {
		iDError (szExeName,ERR000,vInsertarIncidencia, "Error en función bCargaCargos_MC", szfnORAerror());
		return FALSE;
    }
    ...
    {
		iDError (szExeName,ERR000,vInsertarIncidencia, "Error en función bfnFindComuna", szfnORAerror());
		return FALSE;
    }
    ...
    {
		iDError (szExeName,ERR000,vInsertarIncidencia, "Error en función bfnFindCiudad", szfnORAerror());
		return FALSE;
    }
