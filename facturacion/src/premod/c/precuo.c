...
{12,4130,1,0,0,
5,0,0,1,97,0,5,643,0,0,2,2,0,1,0,1,3,0,0,1,97,0,0,
28,0,0,2,103,0,5,671,0,0,2,2,0,1,0,1,3,0,0,1,97,0,0,
51,0,0,3,118,0,5,720,0,0,2,2,0,1,0,1,5,0,0,1,3,0,0,
74,0,0,4,151,0,5,755,0,0,4,4,0,1,0,1,3,0,0,1,3,0,0,1,3,0,0,1,3,0,0,
105,0,0,5,103,0,5,786,0,0,2,2,0,1,0,1,3,0,0,1,3,0,0,
};
 ...
 for (iInd1=0;iInd1<stCliente.iNumCabCuotas;iInd1++)
 {
      for (iInd2=0;iInd2<pTmpCab[iInd1].iNCuotas;iInd2++)
      {
           ...
           if (pTmpCuotas[iInd2].dImpCuota >= 0.01)
           {
               ...
               stPreFactura.A_PFactura.bOptCuotas  [i] = TRUE                 ;
