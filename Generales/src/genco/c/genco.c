0,0,2,3,0,0,2,3,0,0,2,3,0,0,
897,0,0,25,287,0,5,1157,0,0,8,8,0,1,0,1,4,0,0,1,5,0,0,1,3,0,0,1,3,0,0,1,3,0,0,
1,5,0,0,1,3,0,0,1,3,0,0,
944,0,0,26,282,0,5,1173,0,0,9,9,0,1,0,1,4,0,0,1,5,0,0,1,3,0,0,1,3,0,0,1,3,0,0,
...
/*                                                                          */
/*    Ampliacion del largo del Prefijo de Folio y Prefijo Plaza             */
/*    de 4 a 11 caracteres.						    */
/****************************************************************************/
...
**/
{
	...
	/* EXEC SQL BEGIN DECLARE SECTION; */ 
		...
		short   shIndNumVenta       ;
		short   shIndFolioCTC       ;
		/*char    szhPrefPlaza[4]      ; EXEC SQL VAR szhPrefPlaza IS STRING(4);*/ /* jlr_11.01.03 */ /* Comentado por PGonzalez 17-03-2004 */		
...
/* EXEC SQL 
	...
	(	:lhCodCliente ,
		...
		TO_DATE(:szhFecVencimie:shIndFecVencimie,'YYYYMMDDHH24MISS'),
		SYSDATE, 
		TO_DATE(:szhFecAntiguedad,'YYYYMMDD'),
...
sqlstm.sqladtp = &sqladt;
sqlstm.sqltdsp = &sqltds;
sqlstm.stmt = "insert into CO_CARTERA (COD_CLIENTE,NUM_SECUENCI,COD_TIPDOCUM\
,COD_VENDEDOR_AGENTE,LETRA,COD_CENTREMI,COD_CONCEPTO,COLUMNA,COD_PRODUCTO,IMPO\
RTE_DEBE,IMPORTE_HABER,IND_CONTADO,IND_FACTURADO,FEC_EFECTIVIDAD,FEC_VENCIMIE,\
FEC_CADUCIDA,FEC_ANTIGUEDAD,FEC_PAGO,NUM_ABONADO,NUM_FOLIO,NUM_CUOTA,SEC_CUOTA\
,NUM_TRANSACCION,NUM_VENTA,NUM_FOLIOCTC,PREF_PLAZA,COD_OPERADORA_SCL,COD_PLAZA\
) values (:b0,:b1,:b2,:b3,:b4,:b5,:b6,:b7,:b8,:b9,:b10,:b11,:b12,TO_DATE(:b13,\
'YYYYMMDDHH24MISS'),TO_DATE(:b14:b15,'YYYYMMDDHH24MISS'),SYSDATE,TO_DATE(:b16,\
'YYYYMMDD'),TO_DATE(:b17,'YYYYMMDD'),:b18:b19,:b20:b21,:b22:b23,:b24:b25,:b26:\
...
sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
	...
	fprintf( stdout, "sqlca.sqlcode en cartera[%d]\n", sqlca.sqlcode );
	if( sqlca.sqlcode != 0 )
	{
		fprintf(stderr,"GENERAL ERROR al insertar en CO_CARTERA %d : %s\n",sqlca.sqlcode,sqlca.sqlerrm.sqlerrmc);
		fflush(stderr);
		return FALSE;
	}
