...
24,0,0,2,85,0,4,76,0,0,3,2,0,1,0,1,5,0,0,1,3,0,0,2,5,0,0,
51,0,0,3,280,0,4,129,0,0,11,1,0,1,0,2,3,0,0,2,5,0,0,2,5,0,0,2,5,0,0,2,5,0,0,2,
...
/*    vDTrazasLog (szExeName,"\n\t\t* Suma Dias Fechas : %s +  %d \n",LOG05,szhFecha2,ihNumDias); */
    ...
    /* EXEC SQL    SELECT TO_CHAR((TO_DATE (:szhFecha2,'YYYYMMDD') + :ihNumDias),'YYYYMMDDHH24MISS')
                INTO    :szhFecha1
                FROM    DUAL; */ 

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "select TO_CHAR((TO_DATE(:b0,'YYYYMMDD')+:b1),'YYYYMMDDHH2\
4MISS') into :b2  from DUAL ";
    sqlstm.iters = (unsigned int  )1;
