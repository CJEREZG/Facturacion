...
LINKCC=$(PURECMDS) $(CCC) $(LDFLAGS) -norunpath -mt -nocx -dy $(COMPOBJSCC)
...
NOKPIC_CCFLAGS= -Xa $(PROFILE) -xstrconst -xF $(XS) $(MR) \
        -xarch=v8 -xcache=16/32/1:1024/64/1 -xchip=ultra 
# rao -D_REENTRANT
NOKPIC_CCFLAGS64= -Xa $(PROFILE) -xstrconst -xF $(XS) $(MR) \
        -xildoff -errtags=yes -v -xarch=v9 -xchip=ultra \
        -DSS_64BIT_SERVER -DBIT64 -DMACHINE64 
# rao -D_REENTRANT \

CCFLAGS= $(NOKPIC_CCFLAGS) $(KPIC_OPTION)
FASTCCFLAGS= $(NOKPIC_CCFLAGS)

NOKPIC_CCFLAGSCC= $(PROFILE) -xF -noex $(XS) \
	-xarch=v8 -xcache=16/32/1:1024/64/1 -xchip=ultra 
# rao -D_REENTRANT
CCFLAGSCC= $(NOKPIC_CCFLAGSCC) -KPIC
FASTCCFLAGSCC= $(NOKPIC_CCFLAGSCC)
...
LLIBSQLNET = $(LDFLAGSLIST) $(LLIBNSGR) $(LLIBNZJS) $(LLIBNETWORK) $(LLIBNL)
...
PROLDLIBS=$(LDPATHFLAG)$(LIBHOME) $(DYNAMICPROLDLIBS) 
...
CCFLAGS= $(NOKPIC_CCFLAGS64) -K PIC -DPRECOMP
...
CPLUS_CFLAGS=$(OPTIMIZE) $(INCLUDE) -DSLTS_ENABLE 
# rao -D_REENTRANT
...
#RAO20030131
##########################################
PROCFLAGS=sqlcheck=full SQLCHECK=SEMANTIC ireclen=255 oreclen=255 include=$(H) include=$(GE_INC_PATH) code=ansi_c
